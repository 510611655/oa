        ...
        <tbody>
            <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="operate">
                        ...
                        <?php if(is_array($three_auth)): $i = 0; $__LIST__ = $three_auth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$three): $mod = ($i % 2 );++$i; if($three['s_name'] != '删除'): ?><a href="/index.php/Admin/Dept/<?php echo ($three['a_name']); ?>/id/<?php echo ($v['id']); ?>"><?php echo ($three['s_name']); ?></a>&nbsp;&nbsp;
                                <?php else: ?>
...
<script type="text/javascript">
    ...
    $(".count").click(function(){
        ...
        if($("#container").css('display')=="none"){
            ...
            //用AJAX进行数据请求
            $.ajax( {
                url : "/index.php/Admin/Dept/getDeptNum" ,
                type : "post" ,
                datatype : "json" ,
                success : function ( data ) {
                    var dept = [];
