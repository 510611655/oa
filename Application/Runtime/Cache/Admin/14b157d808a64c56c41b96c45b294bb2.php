...
<form action="/index.php/Admin/Doc/add" method="POST" id="theform" enctype="multipart/form-data">
<div class="main">
    <p class="short-input ue-clear">
    	<label>公文标题</label>
        <input type="text"  name="title" placeholder="公文标题" />
    </p>
    <p class="short-input ue-clear">
        <label>附件</label>
    ...
    <p class="short-input ue-clear">
        <label>发布人</label>
        <input type="text" style="border:none;"  name="author" disabled value="<?php echo (session('oa_username')); ?>" />
    </p>
