        	...
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="operate">
					...
					<?php if(is_array($three_auth)): $i = 0; $__LIST__ = $three_auth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$three): $mod = ($i % 2 );++$i; if($three['s_name'] != '删除'): ?><!--<a href="/index.php/Admin/Email/<?php echo ($three['a_name']); ?>/id/<?php echo ($vo['id']); ?>"><?php echo ($three['s_name']); ?></a>&nbsp;&nbsp;-->
							<a href="javascript:;" re_id="<?php echo ($vo['id']); ?>" file="<?php echo ($vo['file']); ?>" class="restore"><?php echo ($three['s_name']); ?></a>&nbsp;&nbsp;

							<?php else: ?>
							<a href="javascript:;" id="<?php echo ($vo['id']); ?>" file="<?php echo ($vo['file']); ?>" class="delete"><?php echo ($three['s_name']); ?></a>&nbsp;&nbsp;<?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</td>
...
<script type="text/javascript">
    ...
    $(".delete").bind("click",function() {
        ...
        layer.confirm( '是否确定要删除？' , {
            ...
            $.ajax( {
                type : "get" ,
                url : "/index.php/Admin/Email/truedel" ,
    ...
    $(".restore").bind("click",function() {
        ...
        layer.confirm( '是否确定要还原？' , {
            ...
            $.ajax( {
                type : "get" ,
                url : "/index.php/Admin/Email/restore" ,
                data : { 'id' : id } ,
                dataType : "json" ,
                beforeSend:function(){
                    //loading层
